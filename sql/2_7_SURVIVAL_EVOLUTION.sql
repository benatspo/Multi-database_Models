...
CREATE TABLE SQL_NOSQL_DBMS_TYPE_SURVIVAL_ANALYSIS_REPO_GLOBAL_NO_FORK (
    REPOSITORY_NAME VARCHAR2,
    MIN_VERSION INTEGER,
    MAX_VERSION INTEGER,
    SOURCE_STATE VARCHAR2,
...
INSERT INTO SQL_NOSQL_DBMS_TYPE_SURVIVAL_ANALYSIS_REPO_GLOBAL_NO_FORK
SELECT * FROM SQL_NOSQL_DBMS_TYPE_SURVIVAL_ANALYSIS_REPO_GLOBAL WHERE REPOSITORY_NAME IN (SELECT REPOSITORY_NAME FROM SQL_NOSQL_DATASET_REPOSITORIES WHERE FORK <> "true");